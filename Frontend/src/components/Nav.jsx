...
const Nav = () => {
  ...
  return (
    ...
    <nav className='flex text-lg  gap-10 justify-center items-center w-1/2 py-3  bg-gray-200 rounded-xl '>
      <NavLink to={'/'} className={({isActive}) => isActive ?"text-blue-500 font-bold decoration underline" : "text-black"}>Products</NavLink>
      {isAdmin? <>
      ...
      {isLoggedIn? <>
       <NavLink to={'/user-profile'} className={({isActive}) => isActive ?"text-blue-500 font-bold decoration underline" : "text-black"}>Profile</NavLink>
